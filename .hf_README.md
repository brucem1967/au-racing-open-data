...
language:
  - en
pretty_name: Australian Racing Open Data
tags:
  - sports
  - horse-racing
  - greyhound-racing
...
size_categories:
  - 100K<n<1M
configs:
  - config_name: track_geometry
    data_files: datasets/track_geometry/track_geometry.csv
  - config_name: track_geometry_sources
    data_files: datasets/track_geometry/track_geometry_sources.csv
  - config_name: track_first_split_distances
    data_files: datasets/track_geometry/track_first_split_distances.csv
  - config_name: greyhound_sectionals_qld
    data_files: datasets/greyhound_sectionals_qld/greyhound_sectionals_qld.csv
  - config_name: greyhound_weights_vic
    data_files: datasets/greyhound_weights_vic/greyhound_weights_vic.csv
  - config_name: track_weather
    data_files: datasets/track_weather/track_weather_*.csv
---
